...
# from . import dist_util, logger ## SageMaker
from . import logger
from . import dist_util_smdp as dist_util

from .fp16_util import MixedPrecisionTrainer
from .nn import update_ema
# from .resample import LossAwareSampler, UniformSampler ## SageMaker
from .resample_smdp import LossAwareSampler, UniformSampler
        ...
        *,
        ...
        if th.cuda.is_available():
            ...
            self.ddp_model = DDP(
                ...
                output_device=int(os.environ["LOCAL_RANK"]),  ## SageMaker
...
#                 th.cuda.synchronize()
                ...
                print('Step: [{0}][{1}] '
                      'Train_Time={2:.3f}, '
                      'Train_Speed={3:.3f} samples/sec,'.format(
                          self.step + self.resume_step,
                          len(batch),
                          batch_duration,
                          world_size * self.batch_size / batch_duration))
...
#     return logger.get_dir()
    return os.environ['DIFFUSION_BLOB_LOGDIR']
